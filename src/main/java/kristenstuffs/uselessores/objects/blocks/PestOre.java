...
public class PestOre extends FallingBlock {

   public PestOre(Block.Properties properties) {
      super(properties);
   }
         ...
         if (p_196443_2_.getBlockState(blockpos).isAir()) {
            if (p_196443_2_.isRemote) {
               for(int j = 0; j < 128; ++j) {
                  ...
                  p_196443_2_.addParticle(ParticleTypes.HEART, d1, d2, d3, (double)f, (double)f1, (double)f2);
               }
            } else {
